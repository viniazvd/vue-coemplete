...
function findBy(xs, query, key) {
  ...
  return xs.filter(function (option) {
    return normalizeString(option[key]).includes(query);
  });
}
...
function setDiacritic(xs, normalizeProp, searchProp) {
...
var script$2 = Vue.extend({
  ...
  computed: {
    ...
    __items: function () {
      ...
      var xs = setDiacritic(this.options, this.normalizeProp, this.searchProp);
...
const __vue_inject_styles__$2 = function (inject) {
  ...
  inject("data-v-77cbbc56_0", {
    ...
    map: {
      ...
      "names": [],
      "mappings": "AA2MA;EACA,aAAA;EACA,sBAAA;EAEA,kBAAA;EAEA,iBAAA;AC5MA;AD8MA;EACA,aAAA;EACA,gBAAA;EACA,kBAAA;AC5MA;AD8MA;EACA,OAAA;EACA,UAAA;EACA,WAAA;EACA,YAAA;EACA,YAAA;EACA,eAAA;EACA,kBAAA;EACA,mBAAA;EACA,mBAAA;EACA,4BAAA;EACA,kCAAA;AC5MA;;AAEA,2CAA2C",
